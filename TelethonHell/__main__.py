...
# Global Variables #
HELL_PIC = "https://te.legra.ph/file/978c82569c1886a27e991.jpg"
...
async def start_hellbot():
    try:
        ...
        LOGS.info("Head to @all_plugins_setup for Updates. Also join chat group to get help regarding HellBot.")
